    ...
    public class StudentEndpointController : Controller
    {
        ...
        public async Task<IActionResult> CreateStudent(Student student)
        {
            ...
            using (var connection = new MySqlConnection(_configuration.GetConnectionString("BotDatabase")))
            {
                ...
                cnt = new MySqlCommand("INSERT INTO student (user_id, first_name, last_name) VALUES (@UserId, @FirstName, @LastName)");
                cnt.Parameters.AddRange(new[]
                {
        ...
        public async Task<IActionResult> UpdateStudent(Student student)
        {
            ...
            using (var connection = new MySqlConnection(_configuration.GetConnectionString("BotDatabase")))
            {
                ...
                var cnt = new MySqlCommand("UPDATE student set user_id=@UserId, first_name=@FirstName, last_name=@LastName where id=@Id",
                    connection);
                cnt.Parameters.AddRange(new[]
                {
                    new MySqlParameter("UserId", userId),
